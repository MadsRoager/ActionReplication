...
type FrontendClient interface {
	...
	Result(ctx context.Context, in *Void, opts ...grpc.CallOption) (*BidRequest, error)
}
...
func (c *frontendClient) Result(ctx context.Context, in *Void, opts ...grpc.CallOption) (*BidRequest, error) {
	out := new(BidRequest)
...
type FrontendServer interface {
	...
	Result(context.Context, *Void) (*BidRequest, error)
...
func (UnimplementedFrontendServer) Result(context.Context, *Void) (*BidRequest, error) {
